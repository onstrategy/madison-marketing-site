...
// ============================================================================
// /kendal — same layout as ../book-a-demo (recreated from madisonai.com/demo),
// but the card holds Kendal's own Calendly scheduling widget instead of the
        ...
        <Reveal delay={100}>
          <div className="light rounded-2xl border border-default bg-surface p-8">
            <h2 className="mb-1 text-2xl font-medium tracking-tight text-primary">
              Schedule a call with Kendal
            </h2>
            <p className="mb-6 text-sm text-secondary">
              Pick a time that works for you, and we'll see you then.
            </p>
            <CalendlyInlineWidget person="kendal" />
          </div>
        </Reveal>
      </div>
    </section>
...
export default function KendalPrototype() {
  return (
