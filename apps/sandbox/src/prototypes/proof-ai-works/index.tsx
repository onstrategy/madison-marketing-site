import { ContentPage } from "../../content/sections/renderer";
import type { SectionInput } from "../../content/sections/schema";
...
const SECTIONS = [
  {
    ...
    props: {
      ...
      role: "CEO, Madison AI",
      opener:
        "There's a lot of noise around AI right now. Big promises, bigger price tags, and not much proof.",
    },
  },
  {
    type: "news-intro",
...
export default function ProofAiWorksPrototype() {
  return (
    <ContentPage
      sections={SECTIONS}
      source="proof-ai-works-in-the-public-sector"
    />
  );
}
