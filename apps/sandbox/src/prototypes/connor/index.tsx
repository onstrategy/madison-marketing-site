...
// ============================================================================
// /connor — same layout as ../book-a-demo (recreated from madisonai.com/demo),
// but the card holds Connor's own Calendly scheduling widget instead of the
      ...
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-2 lg:items-center">
        ...
        <Reveal delay={100}>
          <div className="light rounded-2xl border border-default bg-surface p-8">
            ...
            <CalendlyInlineWidget person="connor" />
          </div>
        </Reveal>
      </div>
    </section>
...
export default function ConnorPrototype() {
  return (
